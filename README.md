...
On a terminal with Docker: ```sudo docker run -p 7777:7777 -p 7777:7777/udp -p 7778:7778 -p 7778:7778/udp -p 27016:27016 -p 27016:27016/udp -p 27015:27015/udp -p 27015:27015 -p 4380:4380/udp -p 80:80 -p 443:443 -e EULA=accept -e ADMINSTEAMID=SteamId64 -e SERVERNAME="Your Server Name" --name  DOD_SERVER xenium/dayofdragons```.
